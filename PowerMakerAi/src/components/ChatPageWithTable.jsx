        ...
        <div className={`input-card2 overflow-auto hide-scrollbar md:max-h-[560px]  relative  md:w-[734px] md:max-w-[734px] flex flex-col gap-4 ${isShowPreviewClicked ? '!mt-[-30px] !mb-auto' : ''}`}>
            ...
            <div className="output-text flex gap-4">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <button className="show-preview self-start text-[12px] font-[400] text-[#81817C] border-1 border-[#81817C] !px-4 !py-1 rounded-md cursor-pointer hover:bg-[#b9b9b8] hover:text-[#082343] trabsition-all duration-300" onClick={() => setIsShowPreviewClicked(!isShowPreviewClicked)}>Show Preview</button>
                </div>
            </div>
            {/* ------------------Entity Table------------------- */}
            {isShowPreviewClicked && <EntityTable />}
            {/* ------------------Attribute Table------------------- */}
            {isShowPreviewClicked && <AttributeTable />}
            {/* ------------------------Relationship Table---------------- */}
