...
function RelationshipTable() {
    return (
        <div className="relationship-area md:w-[734px] md:max-w-[734px] flex flex-col gap-6">
            ...
            <div className="relationship-table rounded-md overflow-hidden shadow-[0px_2px_4px_0px_#00000014] border border-[#E6E6E6]">
                <table className="w-full table-fixed border-separate border-spacing-0">
                    <thead className='bg-[#F4F4F4] h-[41px]'>
                        <tr>
                            ...
                            <th className="w-[160px] text-[14px] font-[400] text-[#81817C] text-left border border-[#E6E6E6] !px-4">Referencing Entity </th>
