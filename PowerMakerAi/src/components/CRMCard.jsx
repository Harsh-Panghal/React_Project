    ...
    return (
        <>
          ...
          font-[500] leading-[100%] text-center capitalize font-[Roboto]"> "Your connection information is protected with industry-standard encryption."</p>
                ...
                <div className="connection-add-area md:max-w-[430.45px]  flex flex-col gap-4">
                    <h2 className="text-[#000000] text-[16px] font-[500] font-[Roboto]">Add New Connection</h2>
                    <div className="connection-name relative w-[400px]">
                        <input
                            type="text"
                            id="connectionName"
                            placeholder=" "
                            ...
                            className="peer md:max-w-[425px] md:w-[425px] min-h-[38px] pt-5 !pl-4 text-[#082343] text-[14px] font-[400] opacity-50 border border-[#08234333] rounded-[6px] focus:outline-none transition-all"
                        />
                        <label
        ...
        `}
                    ...
                    <div className=" Tenant-id relative w-[400px] ">
                        <img src={isEyeIconClicked1 ? eyeSlashIcon : eyeIcon} alt="eyeIcon" className="absolute top-[12px] right-[-14px] w-[14px] cursor-pointer z-10" onClick={() => setIsEyeIconClicked1(!isEyeIconClicked1)} />
                        <input
        ...
        `}
                    ...
                    <div className="client-id relative w-[400px]">
                        <img src={isEyeIconClicked2 ? eyeSlashIcon : eyeIcon} alt="eyeIcon" className="absolute top-[12px] right-[-14px] w-[14px] cursor-pointer z-10" onClick={() => setIsEyeIconClicked2(!isEyeIconClicked2)} />
                        <input
        ...
        `}
                    ...
                    <div className="client-secret relative w-[400px]">
                        <img src={isEyeIconClicked3 ? eyeSlashIcon : eyeIcon} alt="eyeIcon" className="absolute top-[12px] right-[-14px] w-[14px] cursor-pointer z-10" onClick={() => setIsEyeIconClicked3(!isEyeIconClicked3)} />
                        <input
        ...
        `}
                    ...
                    <div className=" resource-url relative w-[400px]">
                        <input
                            type="text"
                            id="resourceUrl"
                            placeholder=" "
        ...
        `}
                    ...
                    <div className="default-crm relative w-[400px]">
                        <input
                            type="text"
                            id="add2"
                            placeholder=" "
        ...
        `}
                ...
                <div className="crm-btn md:max-w-[431px] md:w-[431px] min-h-[45px] !mt-[8px] flex justify-between">
                    <button className="border-[1px] font-[700] text-[#0E5185] border-[#0E5185] rounded-md md:max-w-[201px] md:w-[201px] md:h-[44px] text-[14px] cursor-pointer hover:scale-[1.01] transition-all duration-100 ease-in">Clear</button>
                    <button className="border-[1px] border-[#0E5185] rounded-md md:max-w-[201px] md:w-[201px] md:h-[44px] bg-[#0E5185] text-[14px] text-[#FFFFFF] font-[700] hover:scale-[1.01] transition-all duration-100 ease-in cursor-pointer" >Save</button>
                </div>
            </div>
        </>
    );
