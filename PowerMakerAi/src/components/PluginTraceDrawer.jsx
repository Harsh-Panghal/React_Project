...
function PluginTraceDrawer({ setIsPluginTraceDrawerOpen }) {
    ...
    return (
        <div className={`absolute top-0 right-0 z-50 flex items-start gap-4 transition-all transform duration-300 ease-in-out
    ${isDrawerVisible ? 'translate-x-0 opacity-100' : 'translate-x-full opacity-0'}`}>
            ...
            />
            <div className="side-drawer-card md:w-[548px] md:max-w-[548px] h-[100vh] bg-[#FFFFFF] border-2 border-[#E6E6E6] opacity-97 flex flex-col gap-4 !px-4 !py-6 ">
                <h2 className="text-[#082343] text-[18px] font-[600]">Details</h2>
                <div className='md:w-[494px] md:max-w-[494px] flex justify-start gap-2.5 '>
                ...
                <div className="md:w-[494px] md:h-[636px] md:max-h-[636px] border border-[#E6E6E6] rounded-md !pl-2 !pt-2.5">
